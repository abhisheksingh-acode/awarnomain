...
<body style="width: 100vw; height: 100vh;">
   ...
   <aside class="bg-dark h-100 text-left d-flex flex-column justify-content-start pt-0 fw-bolder"
         ...
         <nav>
            ...
            <nav class="text-white btn drop-down-menu active-drop-down bg-danger">Pages <i class="fas fa-sort-down ps-5"></i></nav>
 ...
 <select class="form-select" aria-label=" example" id="pageSelect">
  ...
  <option value="contact">Contact</option>
            ...
            <div class="mb-3">
               ...
               <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" required>Awarno is an ambitious web designing company which makes industry level website from cutting edge technologies. Our websites will help you in establishing your business online and drive sales exponentially with the coordination from our digital marketing team.</textarea>
            </div>
  ...
  <!-- first section ends  -->
  <div class="container mx-auto" id="homePageSectionData">
            <div class="row align-items-center d-flex justify-content-between">
     ...
     <div class="container mx-auto">
         ...
         <div class="container mx-auto">
            ...
            <div class="row mt-3">
               ...
               <!-- add service section  -->
               <div class="mb-3">
               <label for="exampleFormControlInput1" class="form-label">Author<span class="star">*</span></label>
               <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Title for header"
                  required>
            </div>
               <div class="mb-3">
