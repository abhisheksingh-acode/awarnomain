...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-172503404-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-172503404-1');
</script>
  ...
  <meta name="keywords"
    content="software, hardware, showcase, portfolio, partner, projects, modern, it, digital, studio, storage, animation, transition, backup">
  ...
  <!-- FAVICON FILES -->
  <link href="images/awarno-favicon.png" rel="shortcut icon">
  <link rel="icon" href="images/awarno-favicon.png">
